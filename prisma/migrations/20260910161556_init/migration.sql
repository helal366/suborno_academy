...
-- CreateTable
CREATE TABLE "subjects_of_subject_teacher" (
    "id" TEXT NOT NULL,
    "subject_name" TEXT NOT NULL,
    "teacher_id" TEXT NOT NULL,
    "created_by_id" TEXT,
    ...
    CONSTRAINT "subjects_of_subject_teacher_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_staff_positions" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_staff_positions_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_staff_roles" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_staff_roles_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "academic_teachers_full_name_mobile_number_key" ON "academic_teachers"("full_name", "mobile_number");
...
-- CreateIndex
CREATE INDEX "_staff_positions_B_index" ON "_staff_positions"("B");

-- CreateIndex
CREATE INDEX "_staff_roles_B_index" ON "_staff_roles"("B");
...
-- AddForeignKey
ALTER TABLE "academic_results" ADD CONSTRAINT "academic_results_staff_id_fkey" FOREIGN KEY ("staff_id") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "teacher_joining_history" ADD CONSTRAINT "teacher_joining_history_staff_id_fkey" FOREIGN KEY ("staff_id") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "spouse_infromation" ADD CONSTRAINT "spouse_infromation_staff_id_fkey" FOREIGN KEY ("staff_id") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "subjects_of_subject_teacher" ADD CONSTRAINT "subjects_of_subject_teacher_teacher_id_fkey" FOREIGN KEY ("teacher_id") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "subjects_of_subject_teacher" ADD CONSTRAINT "subjects_of_subject_teacher_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "subjects_of_subject_teacher" ADD CONSTRAINT "subjects_of_subject_teacher_updated_by_id_fkey" FOREIGN KEY ("updated_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_staff_positions" ADD CONSTRAINT "_staff_positions_A_fkey" FOREIGN KEY ("A") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_staff_positions" ADD CONSTRAINT "_staff_positions_B_fkey" FOREIGN KEY ("B") REFERENCES "user_positions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_staff_roles" ADD CONSTRAINT "_staff_roles_A_fkey" FOREIGN KEY ("A") REFERENCES "academic_teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_staff_roles" ADD CONSTRAINT "_staff_roles_B_fkey" FOREIGN KEY ("B") REFERENCES "user_roles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
